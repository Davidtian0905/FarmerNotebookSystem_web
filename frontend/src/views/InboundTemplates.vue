              ...
              <div v-if="editingTemplateId === template.id" class="template-description edit-mode">
                <div class="edit-field-row">
                  <input 
                    ...
                    @click.stop
                  />
                  <select v-model="editForm.materialType" class="edit-select material-type-select" @click.stop>
                ...
                <div class="edit-field-row">
                  <select v-model="editForm.materialGrade" class="edit-select material-grade-select" @click.stop>
